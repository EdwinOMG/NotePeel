...
export default function MobileSettings({ userEmail, onBack, onLogout, darkMode, onToggleDarkMode, onNavigate }: MobileSettingsProps) {
    ...
    <div style={{ minHeight: '100vh', background: theme.bg, display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ flex: 1, padding: '20px 16px' }}>
        ...
        <div style={{
          ...
          <div style={{ padding: '12px 16px' }}>
            ...
            <div style={{
              ...
              <div>
                <p style={{ margin: '0 0 2px', fontSize: '12px', color: theme.textSecondary, fontFamily: "'Inter', sans-serif" }}>
                  Your plan
                </p>
              ...
              <button
                ...
                style={{
                  ...
                  color: (currentPlan === 'pro' || currentPlan === 'premium') ? theme.textSecondary : '#5D4037',
                  border: 'none',
                  borderRadius: '8px',
                  fontSize: '12px',
                  fontWeight: 600,
        ...
        <div style={{
          background: theme.cardBg, borderRadius: '16px', overflow: 'hidden',
          border: `1px solid ${theme.border}`, marginBottom: '16px',
          animation: 'fadeIn 0.3s ease-out', animationDelay: '0.09s',
        }}>
          <div style={{ padding: '16px', borderBottom: `1px solid ${theme.border}` }}>
            <h3 style={{ margin: 0, fontSize: '13px', fontWeight: 700, color: theme.textSecondary, textTransform: 'uppercase', letterSpacing: '0.5px', fontFamily: "'Inter', sans-serif" }}>
              Legal & Support
